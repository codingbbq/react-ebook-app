...
const Search = ({ setSearchSection }) => {
    ...
    const navigate = useNavigate(); // To Redirect to the Products page
    const searchRef = useRef(); // To get the entered value in the input search

    // When form is submitted
    const handleSearch = (event) => {
        event.preventDefault();
        setSearchSection(false); // To hide the search bar when
